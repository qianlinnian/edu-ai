...
import { fetchSSE, createAbortController } from '../../services/api'
import { useSessionStore } from '../../hooks/useChatSession'
      ...
      .then(({ data }: { data: ServerSession[] }) => {
        ...
        const merged = [
          ...
          ...data.map((s) => ({
            ...
            messages: [] as { id: number; role: 'user' | 'assistant'; content: string }[],
          })),
        ]
